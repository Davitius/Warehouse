...
<link href="../../assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="../../css/errorcover.css" rel="stylesheet">
  </head>
...
<br><br>
  ...
  <main class="px-3">
    ...
    <p class="lead">დემო ვერსიაში თანამშრომლის და მომწოდებლის წაშლა/შეცვლა გამორთულია.</p>
      <br>
      <a class="btn btn-danger" href="../../goods.php#tab_01">უკან დაბრუნება</a>
    <p class="lead">
  ...
  <footer class="mt-auto text-white-50">
    <p>Cover modified by <a href="">Davitius</a></p>
  </footer>
</div>
